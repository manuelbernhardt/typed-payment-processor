...
object Configuration {
  ...
  final case class RetrieveConfiguration(merchantId: MerchantId, userId: UserId, replyTo: ActorRef[ConfigurationResponse]) extends ConfigurationMessage
  final case class StoreMerchantConfiguration(merchantId: MerchantId, configuration: MerchantConfiguration, replyTo: ActorRef[ConfigurationResponse]) extends ConfigurationMessage
  final case class StoreUserConfiguration(userId: UserId, configuration: UserConfiguration, replyTo: ActorRef[ConfigurationResponse]) extends ConfigurationMessage
